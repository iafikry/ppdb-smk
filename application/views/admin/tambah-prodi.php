...
<div class="container-fluid mt-4">
	<div class="container">
		<h1 class="h3 mb-4 text-dark">Tambah Program Studi</h1>
	</div>
		...
		<div class="card-body">
			<form action="" method="post">
				<di class="row g-3 align-items-center">
					...
					<div class="col-auto">
						<input type="text" autocomplete="off" readonly name="kode" id="kode" class="form-control-plaintext fw-bold" value="<?= $kode; ?>">
					</div>
				</di>
				<div class="row g-3">
					<div class="col">
						<label for="nama" class="form-label text-capitalize">program studi</label>
						<input type="text" autocomplete="off" class="form-control <?= form_error(('nama')) ? 'is-invalid' : '' ?>" name="nama" id="nama" value="<?= set_value('nama') ?>">
					...
					<div class="col">
						...
						<input type="text" autocomplete="off" class="form-control <?= form_error(('kuota')) ? 'is-invalid' : '' ?>" name="kuota" id="kuota" value="<?= set_value('kuota') ?>">
