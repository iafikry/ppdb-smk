...
<html lang="en">
  ...
  <body>
		<header>
			<!-- navbar menu -->
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark-2 sticky-top">
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						...
						<div class="navbar nav ms-auto">
							<a href="" class="btn btn-outline-primary nav-link">Login</a>
						</div>
					</div>
				</div>
			</nav>
		...
		<main>
			...
			<div class="container mt-4">
				<section id="info" class="info d-flex justify-content-center">
					<div class="alert bg-success-daun col-8 text-white mt-2">
				...
				<section id="jurusan" class="jurusan mt-2">
				...
				<section id="visi-misi" class="visi-misi mt-2">
					<div class="row">
						<div class="col-md-7 align-self-center">
							<div class="card rounded-0 border-0">
								<div class="card-body">
									<div class="card-title">
										<h3 class="card-text text-center">Visi & Misi</h3>
									</div>
									<div class="visi mt-3">
						...
						<div class="col-md-5 align-self-center text-center">
							<img src="<?= base_url('assets/img/logo.PNG') ?>" height="200px" class="align-items-center" alt="logo sekolah">
						</div>
					</div>
				</section>
				...
				<section class="profil" id="profil mt-2">
					<div class="row">
						<div class="col-md-5 align-self-center text-center">
							<img src="" alt="foto" class="align-items-center">
						</div>
						<div class="col-md-7 align-self-center">
							<h3 class="text-center card-text">Profil</h3>
